...
public class Mazub {
	 ...
	 */
	public Mazub(int pixelLeftX,int pixelBottomY,double startspeedx,double maxspeedx,double accelerationx,Sprite[] sprites ){
		this.setCurrentPositionX(pixelLeftX);
		this.setCurrentPositionY(pixelBottomY);
	...
	public Mazub(int pixelLeftX,int pixelBottomY,Sprite[] sprites){
		new Mazub(pixelLeftX,pixelBottomY,1.0,3.0,0.9,sprites);
	}
	...
	public void endJump() throws IllegalEndException{
	...
	/**
	 * Return the current ducking state of this M	zub.
	 * @return
	 */
	...
	public Sprite getCurrentSprite(){
		if (!isMoving() &&!hasMovedXLastSecond() && !isDucking() && !isJumping())
			return this.getImageAtIndex(0);
		else if (!isMoving() &&!hasMovedXLastSecond() && isDucking() && !isJumping())
			return this.getImageAtIndex(1);
		else if (!isMoving() && hasMovedXLastSecond() && getDirectionLastMove() == Direction.RIGHT && !isDucking() &&!isJumping())
			return this.getImageAtIndex(2);
		else if (!isMoving() && hasMovedXLastSecond() && getDirectionLastMove() == Direction.LEFT && !isDucking() &&!isJumping())
			return this.getImageAtIndex(3);
		else if (isMoving() && getDirection() == Direction.RIGHT && !isJumping() && !isDucking())
			return this.getImageAtIndex(4);
		else if (isMoving() && getDirection() == Direction.LEFT && !isJumping() && !isDucking())
			return this.getImageAtIndex(5);
		else if (isDucking() && (getDirection() == Direction.RIGHT || (getDirectionLastMove() == Direction.RIGHT && hasMovedXLastSecond())))
			return this.getImageAtIndex(6);
		else if (isDucking() && (getDirection() == Direction.LEFT || (getDirectionLastMove() == Direction.LEFT && hasMovedXLastSecond())))
			return this.getImageAtIndex(7);			
		else if (!isDucking() && ! isJumping() && isMoving() && getDirection() == Direction.RIGHT)
			return (this.getImageAtIndex(8);
		else if (!isDucking() && ! isJumping() && isMoving() && getDirection() == Direction.LEFT)
